...
export const outputPublications = pgTable("output_publications", {
  ...
  playableChannelCount: integer("playable_channel_count").notNull().default(0),
  excludedChannelCount: integer("excluded_channel_count").notNull().default(0),
